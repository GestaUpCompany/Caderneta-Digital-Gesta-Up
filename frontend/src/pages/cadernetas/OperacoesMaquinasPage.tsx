    ...
    <CadernetaLayout title="OP. MÁQUINAS" cadernetaId="operacoes-maquinas">
      ...
      <div className="bg-white rounded-3xl p-6 shadow-lg border border-gray-100 flex flex-col gap-5">
        <div className="flex items-center justify-between gap-3">
          <h2 className="section-title">1. DADOS DA OPERAÇÃO</h2>
          {usuario && (
        ...
        <DatePicker label={<span>DATA <span className="text-red-500">*</span></span>} value={form.data} onChange={(val) => setForm((prev) => ({ ...prev, data: val }))} compact />
