...
export const UNIDADE_DESCRICOES: Record<string, string> = {
  un: 'unidade', m: 'metro', kg: 'quilo', g: 'grama', L: 'litro',
  mL: 'mililitro', cx: 'caixa', pct: 'pacote', sc: 'saco', rl: 'rolo',
  Unidade: 'unidade', Pacote: 'pacote',
}
