...
function buildRegistroFromRow(
  ...
  const fieldsByCaderneta: Record<CadernetaStore, string[]> = {
    ...
    rodeio: ['data', 'pasto', 'numeroLote', 'vaca', 'touro', 'bezerro', 'boi', 'garrote', 'novilha', 'totalCabecas', 'escoreGadoIdeal', 'aguaBoaBebedouro', 'pastagemAdequada', 'animaisDoentes', 'cercasCochos', 'carrapatosMoscas', 'animaisEntrevados', 'animalMorto', 'animaisTratados', 'escoreFezes', 'equipe', 'procedimentos'],
