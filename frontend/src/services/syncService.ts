  ...
  switch (store) {
    ...
    case 'pastagens':
      return {
        ...
        pasto_saida_id: registro.pastoSaidaId || null,
        pasto_saida_area_util: registro.pastoSaidaAreaUtil ? Number(registro.pastoSaidaAreaUtil) : null,
        ...
        pasto_entrada_id: registro.pastoEntradaId || null,
        pasto_entrada_area_util: registro.pastoEntradaAreaUtil ? Number(registro.pastoEntradaAreaUtil) : null,
    ...
    case 'suplementacao': {
      ...
      return {
        ...
        consumo_medio_geral_percent_pv: registro.consumoMedioGeralPercentPV ? Number(registro.consumoMedioGeralPercentPV) : null,
        consumo_medio_30dias_percent_pv: registro.consumoMedio30DiasPercentPV ? Number(registro.consumoMedio30DiasPercentPV) : null,
        consumo_medio_geral_kg_mn: registro.consumoMedioGeralKgMN ? Number(registro.consumoMedioGeralKgMN) : null,
        consumo_medio_30dias_kg_mn: registro.consumoMedio30DiasKgMN ? Number(registro.consumoMedio30DiasKgMN) : null,
        consumo_medio_geral_kg_ms: registro.consumoMedioGeralKgMS ? Number(registro.consumoMedioGeralKgMS) : null,
        consumo_medio_30dias_kg_ms: registro.consumoMedio30DiasKgMS ? Number(registro.consumoMedio30DiasKgMS) : null,
        custo_medio_reais_cab_dia: registro.custoMedioReaisCabDia ? Number(registro.custoMedioReaisCabDia) : null,
        escore_fezes: registro.escoreFezes || null,
    ...
    case 'abastecimento':
      return {
        ...baseData,
        data: brWithTimeToIso(registro.data),
        quem_abasteceu: registro.quemAbasteceu || '',
        operador_motorista: registro.operadorMotorista || '',
        maquina_veiculo: registro.maquinaVeiculo || '',
        maquina_veiculo_id: registro.maquinaVeiculoId || null,
        placa: registro.placa || null,
        total_abastecido: registro.totalAbastecido ? Number(registro.totalAbastecido) : 0,
