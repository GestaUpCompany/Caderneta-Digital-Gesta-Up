...
## Fase 1: Schema DB (Aditiva — sem drops)
...
3. Migrar dados existentes:
   ...
   ```
4. Verificar migração: `SELECT COUNT(*) FROM registros_movimentacao WHERE subtipo IS NOT NULL;`

## Fase 2: Frontend — Atualizar Código
...
## Fase 4: Limpeza (APÓS APROVAÇÃO DO USUÁRIO)
13. `ALTER TABLE registros_movimentacao DROP COLUMN tipo_saida;`
14. `ALTER TABLE registros_movimentacao DROP COLUMN tipo_entrada;`
15. `ALTER TABLE registros_movimentacao DROP COLUMN tipo_destino;`
16. `DROP TYPE tipo_movimentacao_saida;` (se não usado em outra tabela)
17. `DROP TYPE tipo_movimentacao_entrada;` (se não usado em outra tabela)
18. Regenerar tipos Supabase.
